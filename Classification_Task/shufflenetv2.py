...
fh = logging.FileHandler(os.path.join(log_path, 'train-{}{:02}{}-shufflenetv2warmup-Adam'.format(local_time.tm_year % 2000, local_time.tm_mon, t)))
...
for epoch in range(300):
    ...
    with torch.no_grad():
        ...
        filename = os.path.join(os.path.join(compare_result, "ShufflenetV2-{:06}warmup-Adam.pth.tar".format(epoch+1)))
