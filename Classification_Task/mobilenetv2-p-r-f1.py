...
fh = logging.FileHandler(os.path.join(log_path, 'train-{}{:02}{}-mobilenetv2warmup-Adam'.format(local_time.tm_year % 2000, local_time.tm_mon, t)))
...
for epoch in range(300):
    ...
    with torch.no_grad():
        ...
        state = {'state_dict': net.state_dict(),
                         ...
                         'lr_scheduler_state_dict':scheduler_warmup.state_dict()}
        filename = os.path.join(os.path.join(compare_result, "MobilenetV2-{:06}warmup-Adam.pth.tar".format(epoch+1)))
        ...
        with open('/media/jie/DATA/Junjie/PhD_project/Classification-Task/ShuffleNet-Series-master/DetNAS_models/MobileNetV2/log-Adam.txt', 'a+') as fd:
