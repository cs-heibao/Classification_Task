...
fh = logging.FileHandler(os.path.join(log_path, 'train-{}{:02}{}-vgg16warmup-SGD-cosine'.format(local_time.tm_year % 2000, local_time.tm_mon, t)))
...
for epoch in range(1, 301):
    ...
    with torch.no_grad():
        ...
        filename = os.path.join(os.path.join(compare_result, "vgg-{:06}-WarmUp-SGD-cosine.pth.tar".format(epoch+1)))
        ...
        with open(
                '/media/jie/DATA/Junjie/PhD_project/Classification-Task/ShuffleNet-Series-master/DetNAS_models/VGG16/log-SGD-cosine.txt',
                'a+') as fd:
